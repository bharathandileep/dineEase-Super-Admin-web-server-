...
const tasks: TaskTypes[] = [
  ...
  {
    id: 3,
    title: "DineEas v2.1 - Angular and Django",
  ...
  {
    id: 4,
    title: "DineEas v2.1 - React, Webpack",
    description:
  ...
  {
    id: 5,
    title: "DineEas 2.2 - Vue.Js and Laravel",
    description:
      "There are many variations of passages of Lorem Ipsum available.",
    status: "Upcoming",
    priority: "Low",
  ...
  {
    id: 6,
    title: "DineEas 2.3 - Rails, NodeJs, Mean",
    description:
  ...
  {
    id: 7,
    title: "DineEas - Landing page and UI Kit",
