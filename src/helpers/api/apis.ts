export const apiConfig = {
  ...
  menu: {
    ...
    orgemployee: {
      ...
      getOrgEmployeeById: (id: string | undefined) => `/orgemployee/orgemployee/${id}`,
      updateOrgEmployee: (id: string | undefined) => `/orgemployee/orgemployee/${id}`,
      deleteOrgEmployee: (id: string | undefined) => `/orgemployee/orgemployee/${id}`,
